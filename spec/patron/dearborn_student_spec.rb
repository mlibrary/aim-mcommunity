describe Patron::DearbornStudent do
  before(:each) do
  ...
  context "#user_group" do
    it "is 04 for undergrads" do
      @patron["umichdbrncurrenttermstatus"][0].sub!("classStanding=GR", "classStanding=FR")
  ...
  context "#includable?" do
    ...
    it "is false when not registered for any term" do
      @patron["umichdbrncurrenttermstatus"][0].sub!("registered=Y", "registered=N")
